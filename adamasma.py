...
kelimeler = ["vantilatör", "adaptör", "kalem", "fare", "telefon", "kulaklık", "pervane", "merdane", "kestane", "çilek", "elma", "armut", "kiraz", "vişne", "mandalina", "portakal", "buzdolabı", "bulaşık makinesi", "çamaşır makinesi","kurutma makinesi","şofben","Fırın","mikrodalga fırın","Klima","aspiratör","kombi","klima"]
